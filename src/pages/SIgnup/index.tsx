...
export default function Signup(): React.JSX.Element {
  ...
  async function signup() {
    ...
    try {
      const response = await authService.signupWithEmailAndPassword(email, password);
      triggerInfo({title: 'Signup Success',message: 'Your Sign Up is successful. You can now use the full functions of the site'})
