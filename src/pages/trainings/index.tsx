...
import image_1 from "../../assets/cullinary.png"
                ...
                <div>
                    <div className='py-2 py-lg-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={false} actionFn={goToEnroll} price={35000} title='HOSPITALITY/CATERING' image={hospitality} text='Lodging Industry, Food and beverages industry,  Catering Companies, Travel and tourism, etc'  />
                       </div>                       
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={true} actionFn={goToEnroll} price={35000} title='CULINARY ARTS' image={cullinary} text='Culinary skills management, professions in culinary arts, terminologies and phrases, etc'  />
                       </div>
                       
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={false} actionFn={goToEnroll} price={35000} title='PASTRY, DESERTS, PUDDING AND SNACKS' image={pastries} text='ausage roll, Danish pastry, Croissant, turnover, Star Danish, Scotch egg,
...
'  />
                       ...
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={true} actionFn={goToEnroll} price={35000} title='BEVERAGES AND DRINKS' image={beverages} 
...
Custard, Tom Brown, mayonnaise, etc'  />
                        ...
                        <div className='py-2 py-lg-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={false} actionFn={goToEnroll} price={35000} title='BREAD BAKING AND PACKAGING' image={bread} 
...
Fancy bread,  Chocolate bread, dry fruits bread, agege bread, fluffy Milk bread, etc'  />
                       ...
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={true} actionFn={goToEnroll} price={35000} title='CAKES' image={cake} text='Muffin cake, Marble cake, English cake,
...
Honey cake, butter cake, Sponge cake, strawberry cake, Chocolate cake,Red velvet cake, Carrot cake, Coconut cake, Banana cake, Apple, dark chocolate cake, Cocoa Butter cake, etc'  />
                       ...
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={false} actionFn={goToEnroll} price={35000} title='TYPES OF ICING FOR CAKE DECORATIONS' image={icing} text='Butter Icing, Royal Icing, Fondant Icing, sugar paste, whipping cream, pureed fondant, sugar lace, glace icing, sugar sail, sugar glass, sugar sheet, etc'  />
                       </div>
                       
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={true} actionFn={goToEnroll} price={35000} title='WEDDING CAKE' image={weddingCake} text='Cake tier, cake layers, cake board, cake pans, doweling, stacking, color meaning and combination, cake presentation, White wedding cake, traditional wedding cake, bridal shower cake, stencilling, etc. '  />
                       </div>     
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={false} actionFn={goToEnroll} price={35000} title='CAKE CRAFTS' image={cakecraft} text='Cinderella cake decoration, Teddy bear cake, shirt cake, Face cap and Polo cake, Football stadium, aeroplane cake, vehicle cake, animals cake,  character cakes (Mickey mouse, butterfly cake, Lions guard, etc), Football pitch cake, Close and Open bible cake, Money box cake,
...
Sewing Machine Cake, noodles Pot Cake, uncompleted building, chair cake, building cake, etc. '  />
                       ...
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={true} actionFn={goToEnroll} price={35000} title='MOLDING CRAFTS' image={molding} text='Molding of bride & groom (suit wears), Molding of bride & groom (Traditional wears), Molding of ladies shoes & hand bag, Molding of fruits, cola nut, garden eggs, beads, corn, beans,  petal sugar rose, Flowers, Orange, Coconut, Banana, Apple, Pineapple, Watermelon, cucumber, Avocado, Grape fruit, pineapple, Sun flower, Calla lily, Stephanotis, Stargazer flower,
Tiger lily, Carnation, etc'  />
                       </div>     
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={false} actionFn={goToEnroll} price={35000} title='CONTINENTAL DISHES AND AFRICAN DISHES' image={cullinary} text='American fried rice, Chinese fried rice,Caribbean fried rice, Nigeria fried rice, Mexican rice, Coconut fried rice, Oriented fried rice, Braised rice, Japanese fried rice
                       ...
                       <div className='py-2 py-md-4' />
                        <div className='training-content'>
                            <TrainingItem reverse={true} actionFn={goToEnroll} price={35000} title='SALAD' image={salad} text='Hasotel Salad, Russian Salad, French Salad, Warm cabbage salad, Coleslaw, Cripy spiced egg salad, Baked Vegetables, Japanese Salad, Greek Salad, Fruit Salad, full salad, average salad, Chicken Salad, etc'  />
                       </div>
                       <div className='py-2 py-md-4' />                      
                    <div className='py-2 py-lg-4' />                    
                </div>
