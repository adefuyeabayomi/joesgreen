          ...
          <div className="tableHeader">
            <div className="container-fluid no-space">
              <div className="d-none d-sm-flex row no-space align-items-center py-1 px-2 my-2 my-sm-0">
                <div className="w-max-content no-space">
                  <p className="font-p font-medium no-space snWidth">S/N</p>
                </div>
                <div className="col no-space">
                  <p className="font-p font-medium no-space">DATE</p>
                </div>
                <div className="col no-space">
                  <p className="font-p font-medium no-space">TIME</p>
                </div>
                <div className="col no-space">
                  <p className="font-p font-medium no-space">TRXN ID</p>
                </div>
                <div className="col no-space">
                  <p className="font-p font-medium no-space">AGENT</p>
                </div>
                <div className="col no-space">
                  <p className="font-p font-medium no-space">ID</p>
                </div>
              </div>
              <div className="row no-space align-items-center py-2 px-2 tx-item-row gray my-2 my-sm-0">
                <div className="w-max-content d-none d-sm-block no-space">
                  <p className="font-p font-regular no-space snWidth">1</p>
                </div>
                ...
                <div className="col-xs-12  col-sm no-space">
                  <p className="font-p font-regular no-space">
                    <span className="d-sm-none">Transaction ID: </span>
                    <span>Prxi2938928918de3</span>
                  </p>
                </div>
                <div className="col-xs-12  col-sm no-space">
                  <p className="font-p font-regular no-space">
                    <span className="d-sm-none">Agent: </span>
                    <span>Monnify</span>
                  </p>
                </div>
                <div className="col-xs-12 col-sm no-space">
