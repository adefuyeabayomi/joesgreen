  ...
  async function resetPassword() {
    ...
    try {
      ...
      triggerInfo({
        title: "Success",
        message:
          "Your password has been saved successfully. You can now login with your new password",
      });
      navigate("/login");
    } catch (error) {
          ...
          <div className="col-11 col-sm-8 col-lg-6 no-space MFormContainer center">
            <div className="loginFormContainer">
              ...
              <p className="font-p no-space text-center font-regular">
                Create a new password for your account. Make sure it is a strong
                password to improve your account security
              </p>
              <div className="py-2" />
              <div>
                <InputMain
