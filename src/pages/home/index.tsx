            ...
            <div className="row flex-column flex-sm-row no-space align-items-center">
              <div className="col-md-6 col-12 no-space">
                <div className="htext-container ">
                  <p className="hAccentItem font-regular">
                    Satisfy those cravings here
                  </p>
                  <div className="py-2" />
                  <h1 className="text-main headline">
                    <span className="green-color-main">Delicious</span> Meals
                    That <span className="green-color-main">Delight</span> Your
                    Senses.
                  </h1>
                  ...
                  <div className="py-2 py-sm-0 hbcontainer">
                    <button
                      className="headlinebutton font-p"
                      onClick={goToOrders}
                    >
                      Order Now!
                    </button>
        ...
        <div className="featuredMainContainer green-bg mainSpacing">
          <div className="featuredContents">
            ...
            <div className="sectionHeadlineContainer features d-sm-none text-main font-subtitle-big font-medium">
              OUR FEATURED CHOP <span className="delicious">BELLE-FULL</span>{" "}
              MENU
            </div>
            ...
            <div className="sectionAfterTextContainer features">
              <p className="font-p font-regular text-main">
              ...
              <div className="row no-space">
                <div className="col-12 col-md-6 col-lg-3 no-space">
                  <div className="fi-content-container firstchild center">
                    <FeaturedCard
                      image={image4}
                      title="Rice Specials: Flavorful Jollof, Savory Fried Rice, White Rice Stew"
                      actionFn={goToOrders}
                    />
                  </div>
                </div>
                <div className="col-12 col-md-6 col-lg-3 no-space">
                  <div className="fi-content-container center">
                    <FeaturedCard
                      image={image2}
                      title="Pasta Delights: Creamy Alfredo, Zesty Marinara, Pesto & More"
                      actionFn={goToOrders}
                    />
                  </div>
                </div>
                <div className="col-12 col-md-6 col-lg-3 no-space">
                  <div className="fi-content-container center">
                    <FeaturedCard
                      image={image3}
                      title="Light Cravings: Savory BBQ and Sauce served to satisfy your buds."
                      actionFn={goToOrders}
                    />
                  </div>
                </div>
                <div className="col-12 col-md-6 col-lg-3 no-space">
                  <div className="fi-content-container center">
                    <FeaturedCard
                      image={image1}
                      title="Nigerian Soups: Rich Egusi, Ogbono, Banga, Vegetable & More"
                      actionFn={goToOrders}
                    />
                  </div>
                </div>
            ...
            <div className="orderspageLinkContainer" onClick={goToOrders}>
              <div className="pointer new-delight row no-space align-items-center">
                <div className="no-space">
                  <p className="font-p font-regular text-main">
                    Visit our orders page to view the menu{" "}
                    <FontAwesomeIcon
                      className="text-main"
                      icon={faCaretRight}
                    />
        ...
        <div className="howItWorksMainContainer mainSpacing">
          <div className="howItWorksContents">
            <div className="howItWorksTextsContainer text-center">
              ...
              <div className="sectionHeadlineContainer d-sm-none text-main font-subtitle-big font-medium">
                HOW OUR <span className="delicious">DELIVERY SERVICE</span>{" "}
                WORKS
              </div>
              <div className="sectionHeadlineContainer ease d-none d-sm-block text-main font-heading-5 font-medium">
                HOW OUR <span className="delicious">DELIVERY SERVICE</span>{" "}
                WORKS.
              </div>
              <div className="sectionAfterTextContainer ease">
                <p className="font-p font-regular text-main">
                  See our most sought after dishes, Order with ease and
                  experience a new world of vibrant taste and delight.
                </p>
              </div>
              <div>
                <div className="row align-items-center">
                  <div className="col-12 col-md-6 col-lg-3">
                    <div className="HIContainerMain">
                      <HowItem
                        image={image8}
                        title="Browse through the menu"
                        text="Choose your pick from our menu."
                      ></HowItem>
                    </div>
                  </div>
                  <div className="col-12 col-md-6 col-lg-3 how_img_special">
                    <div className="HIContainerMain">
                      <HowItem
                        ...
                        text="Check and confirm your order"
                      ></HowItem>
                    </div>
                  </div>
                  <div className="col-12 col-md-6 col-lg-3">
                    <div className="HIContainerMain">
                      <HowItem
                        image={image5}
                        title="Make Payment"
                        text="Proceed to payment. Pay for the order"
                      ></HowItem>
                    </div>
                  </div>
                  <div className="col-12 col-md-6 col-lg-3">
                    <div className="HIContainerMain">
                      <HowItem
                        ...
                        text="Now wait. Your meal is on the way!"
                      ></HowItem>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div
                  className="py-2 py-sm-0 col-12 col-md-8 col-lg-6 center"
                  onClick={goToOrders}
                >
                  <button
                    className="moreMenuBtn font-p white"
                    onClick={goToOrders}
                  >
                    See The Menu <FontAwesomeIcon icon={faArrowRight} />
                  </button>
                </div>
              </div>
            </div>
      ...
      <div className="reviewsContainer">
        <div className="green-bg mainSpacing">
          <div className="reviewsContents">
            ...
            <div className="sectionHeadlineContainer d-sm-none text-main text-center font-subtitle-big font-medium">
              REVIEWS FROM <span className="delicious">OUR CUSTOMERS.</span>
            </div>
            <div className="sectionHeadlineContainer ease d-none d-sm-block  text-center text-main font-heading-5 font-medium">
              REVIEWS FROM <span className="delicious">OUR CUSTOMERS.</span>
            </div>
            <div className="sectionAfterTextContainer ease text-center">
              <p className="font-p font-regular text-main">
                See what our loyal customers have to say about their experiences
                with our services.
              </p>
            </div>
            <div className="py-3" />
        ...
        <div className="bannerSectionMain ">
          <div className="ctaBannerContainer">
            <div className="ctaBannerContents py-5 px-2">
              <p className="font-subtitle d-md-none font-bold text-center">
                DELICIOUS FOOD, AMAZING DINING EXPERIENCE.
              </p>
              ...
              <button
                className="cta-button-container center"
                onClick={goToOrders}
              >
                <div className="w-max-content center pointer row no-space align-items-center">
                  <div className="w-max-content no-space">
                    <p className="font-p tipTitle no-space">Order Now</p>
                  </div>
                  <div className="w-max-content no-space">
                    <img className="caretIcon no-space" src={caretWhite} />
                  </div>
                </div>
              </button>
            </div>
        ...
        <div className="mainSpacing">
          <div className="CSContainer">
            <div>
              ...
              <div className="sectionHeadlineContainer d-sm-none text-main text-center font-subtitle-big font-medium">
                <span className="delicious">GET IN TOUCH</span> WITH US.
              </div>
              <div className="sectionHeadlineContainer ease d-none d-sm-block  text-center text-main font-heading-5 font-medium">
                <span className="delicious">GET IN TOUCH</span> WITH US.
              </div>
              ...
              <div className="row no-space align-items-center justify-content-center">
                <div className="col-12 col-md-4 col-lg-3">
                  <ContactItem
                    image={image15}
                    title="Email: "
                    text="joegreencafeteriaservice@gmail.com"
                  ></ContactItem>
                </div>
                <div className="col-12  col-md-4 col-lg-3">
                  <ContactItem
                ...
                <div className="col-12 col-md-4 col-lg-3">
                  <ContactItem
                    image={image17}
                    title="Location: "
                    text="25 Trans-woji road Port Harcourt. Rivers State"
                  ></ContactItem>
                </div>
              </div>
            </div>
