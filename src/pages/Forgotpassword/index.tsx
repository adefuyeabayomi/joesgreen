  ...
  async function sendForgotPassword() {
    ...
    try {
      ...
      triggerInfo({
        ...
        message:
          "Your password reset link has been sent. Use it to reset your password.",
      });
      navigate("/");
    } catch (error) {
            ...
            <div className="col-12 col-sm-6 no-space">
              <div className="loginFormContainer">
                ...
                <p className="font-p no-space text-center font-regular">
                  Please input the email you used to create the account. If it
                  is in our database, a password reset email would be sent to
                  you. Please note, the link is only valid for 30mins
                </p>
                <div className="py-2" />
                <div>
                  <InputMain
                ...
                <div>
                  <p
                    className="font-small text-center no-space"
                    onClick={sendForgotPassword}
                  >
                    <span className="font-regular pointer">
                      I didn't get Any Mail. Resend it
                    </span>{" "}
                  </p>
                </div>
                <div className="py-2" />
            ...
            <div className="formSupport col-12 col-sm-6 no-space align-items-center row">
              ...
              <div>
                <div className="center text-center" style={{ width: "80%" }}>
                  ...
                  >
                    For Further Assistance, Reach out to us via our support
                    page.
                  </h4>
                </div>
